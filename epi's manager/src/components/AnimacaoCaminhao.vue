    ...
    <div class="fixed bottom-4 right-4">
        <div class="flex items-center justify-center">
            <div class="relative flex h-[100px] w-[200px] flex-col items-center justify-end overflow-x-hidden">
                ...
                <div class="absolute bottom-0 flex h-fit w-[130px] items-center justify-between pl-[15px] pr-[10px]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" class="w-[24px]">
...
#estrada::before,
#estrada::after {
    animation: animacaoEstrada 1.4s linear infinite;
}
</style>