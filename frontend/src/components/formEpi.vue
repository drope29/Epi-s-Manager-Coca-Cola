...
<template>
    <div class="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-center z-40">
        <div class="mx-auto w-[630px] h-[750px] bg-white rounded-xl shadow-lg drop-shadow-md flex flex-col">
            <div class="px-6 py-4 flex justify-between">
                <div>
                    <h2 class="flex font-bold items-center text-4xl">Adicionar EPI's</h2>
                </div>
            ...
            <form @submit.prevent="registrarEPI" class="px-6 pt-3 pb-6 flex-grow flex flex-col justify-between">
